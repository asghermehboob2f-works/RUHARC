...
export const MegaMenu: React.FC<MegaMenuProps> = ({ onClose }) => {
  ...
  return (
    <motion.div
      ...
      className="absolute top-full left-1/2 -translate-x-1/2 mt-4 w-[840px] rounded-3xl glass-panel p-6 shadow-2xl border border-white/10 z-50 bg-[#09090b]/95"
    >
        ...
        {solutions.map((item, idx) => {
          ...
          return (
            <a
              ...
              href="#workspace"
              onClick={onClose}
              className="group p-3.5 rounded-2xl bg-white/[0.03] hover:bg-white/[0.08] border border-white/[0.06] hover:border-white/20 transition-all duration-200 hover:-translate-y-0.5 flex items-start gap-3.5"
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-white/60 line-clamp-2 mt-0.5 leading-relaxed">
                  {item.desc}
                </span>
